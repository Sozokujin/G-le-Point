...
const tiers = [
    {
        ...
        href: '/login',
        priceYearly: '10€',
        description: 'Pour les aventuriers passionnés souhaitant une visibilité accrue.',
        features: [
    ...
    },
    {
        ...
        href: '/login',
        priceYearly: 'Gratuit',
        description: 'Idéal pour les explorateurs désirant partager et découvrir de nouveaux lieux.',
        features: [
    ...
    },
    {
        ...
        href: '/login',
        priceYearly: '40€',
        description: 'Le choix optimal pour les professionnels cherchant à maximiser leur visibilité.',
        features: [
            'Toutes les fonctionnalités du plan Explorateur',
            'Mise en avant de vos lieux partagés',
            'Promotion prioritaire dans les résultats de recherche',
            ...
            <main className="isolate">
                <div className="relative pt-14">
                    ...
                    <div className="mx-auto max-w-7xl px-6 lg:px-8">
                        <div className="mx-auto max-w-2xl text-center">
                            <h1 id="presentation" className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                                Découvrez et partagez des lieux cachés avec le monde
                            </h1>
                            <p className="mt-6 text-lg leading-8 text-gray-600">
                                Rejoignez notre communauté d'explorateurs et enrichissez votre expérience de voyage en explorant
                                des trésors cachés, des panoramas époustouflants et des lieux culturels uniques grâce à notre
                                plateforme collaborative de cartographie.
                            </p>
                        ...
                        <div className="mt-16 flow-root sm:mt-24">
                            <div className="relative overflow-hidden -m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4">
                                ...
                                />
                                <BorderBeam size={800} duration={12} delay={9} colorFrom="#9FCF6D" colorTo="#7CC772" />
                            </div>
                        </div>
                    </div>
                    <div
                ...
                <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
                    <div className="mx-auto max-w-2xl lg:text-center">
                        <h2 id="fonctionnalites" className="text-2xl font-semibold leading-7 text-primary">
                            Explorons ensemble
                        </h2>
                        <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                            Tout ce dont vous avez besoin pour découvrir et partager des lieux uniques
                        </p>
                        <p className="mt-6 text-lg leading-8 text-gray-600">
                            Connectez-vous avec des explorateurs comme vous et partagez des expériences inoubliables. Notre
                            plateforme vous permet de trouver et de signaler des lieux cachés et des trésors peu connus,
                ...
                <div className="mx-auto mt-32 max-w-7xl sm:mt-56 sm:px-6 lg:px-8">
                    <div className="relative overflow-hidden bg-gray-900 px-6 py-20 shadow-xl sm:rounded-3xl sm:px-10 sm:py-24 md:px-12 lg:px-20">
                        ...
                        <div className="relative mx-auto max-w-2xl lg:mx-0">
                            <Image height={64} width={64} src="/images/main-logo-white.svg" alt="Logo G'Le Point" />
                            <figure>
                                <blockquote className="mt-6 text-lg font-semibold text-white sm:text-xl sm:leading-8">
                                    <p>
                                        “Grâce à cette plateforme, j'ai pu découvrir des spots de randonnée incroyables que je
                                        n'aurais jamais trouvés seule. C'est fantastique de pouvoir partager mes propres
                                        trouvailles aussi!”
                                    </p>
                                </blockquote>
                                <figcaption className="mt-6 text-base text-white">
                                    <div className="font-semibold">Alexia D.</div>
                                    <div className="mt-1">Aventurière passionnée et contributrice active</div>
                                </figcaption>
                            </figure>
                        </div>
                    </div>
                ...
                <div className="mt-32">
                    <div className="mx-auto max-w-7xl px-6 lg:px-8">
                        <div className="mx-auto max-w-4xl text-center">
                            <h2 id="tarifs" className="text-2xl font-semibold leading-7 text-primary">
                                Nos Plans
                            </h2>
                        ...
                        <p className="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-gray-600">
                            Choisissez le plan qui vous convient le mieux pour partager et découvrir des lieux uniques et cachés.
                        </p>
                        <div className="isolate mx-auto mt-16 grid max-w-md grid-cols-1 gap-y-8 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                            {tiers.map((tier, tierIdx) => (
                                ...
                                >
                                        ...
                                        <p className="mt-6 flex items-baseline gap-x-1">
                                            <span className="text-4xl font-bold tracking-tight text-gray-900">
                                                ...
                                                {tier.priceYearly !== 'Gratuit' && (
                                                    <span className="align-top text-lg leading-6 text-gray-600">*</span>
                                                )}
                                            </span>
                                        </p>
                                    ...
                                    {tier.priceYearly !== 'Gratuit' && (
                                        <div className="h-6">
                                            <span className="text-xs italic leading-6 text-gray-600">* Valable pendant 1 an</span>
                                        </div>
                                    )}
                                </div>
                            ))}
                ...
                <div className="relative -z-10 mt-32 px-6 lg:px-8">
                    ...
                    <div className="mx-auto max-w-2xl text-center my-36">
                        ...
                        <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-600">
                            Rejoignez notre communauté et commencez à découvrir et partager des lieux uniques et cachés. Votre
                            prochaine grande découverte vous attend.
                        </p>
                        <div className="mt-10 flex flex-col md:flex-row gap-4 items-center justify-center gap-x-6">
                            <Link href="/login">
                                <PulsatingButton className="bg-primary" pulseColor="#00a661">
