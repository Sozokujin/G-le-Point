            ...
            <nav className="flex items-center justify-between h-14 px-6 lg:px-8" aria-label="Global">
                <div className="flex lg:flex-1">
                    <Link href="/" className="-m-1.5 p-1.5">
                        ...
                        <Image width={48} height={48} src="/images/main-logo-green.png" alt="Logo G'Le Point" />
                    </Link>
                </div>
                ...
                <div className="hidden lg:flex lg:flex-1 lg:justify-end">
                    <Link href="/login" className="text-sm font-semibold leading-6 text-gray-900 hover:text-primary duration-150">
