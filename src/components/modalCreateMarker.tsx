...
const ModalCreateMarker = () => {
    ...
    const addMarkerWithCurrentLocation = () => {
        if (!navigator.geolocation) return alert("La géolocalisation n'est pas disponible sur votre navigateur");
    ...
    const addMarkerWithAddress = () => {
        if (addressCoordinates.length === 2) {
            addMarkerCommon(addressCoordinates[1], addressCoordinates[0], pointAddressRef.current?.value || '');
        }
    };
    ...
    return (
        <Dialog>
            ...
            <DialogContent>
                ...
                {display === 'address' && (
                    <>
                        <AutocompleteMapbox onAddressCoordinatesSelected={handleAddressCoordinates} />
                        <DialogClose asChild>
                ...
                {display === 'gps' && (
                    <>
                        ...
                        <Input id="gps" type="text" placeholder="Exemple: 48.86127461, 2.334830083" ref={pointGpsRef} />
                        <DialogClose asChild>
