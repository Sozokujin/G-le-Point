...
import { ClipboardDocumentIcon, CheckIcon, MapPinIcon } from '@heroicons/react/24/solid';
...
export const MarkerList: React.FC<MarkerListProps> = ({ markers, showUser = false }) => {
                            ...
                            {markers.map((marker) => (
                                <div key={marker.id} className="p-4 bg-slate-100 rounded-lg shadow">
                                    ...
                                    <div className="w-full flex justify-between mb-3">
                                        {marker.description && (
                                            <div className="text-sm text-slate-400 truncate">{marker.description}</div>
                                        )}
                                        {marker.address && (
                                            <div className="text-sm text-slate-400 truncate">
                                    ...
                                    <div className="flex gap-4">
                                        ...
                                        <Button className="p-1 w-6 h-6 rounded-full" onClick={() => copyToClipboard(marker)}>
